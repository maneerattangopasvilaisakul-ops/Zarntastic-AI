...
export function FastworkReviews() {
  ...
  return (
    <section id="reviews-section" className="bg-gradient-to-b from-slate-900 via-slate-900 to-slate-950 text-white rounded-3xl p-6 sm:p-8 lg:p-10 border border-slate-800 shadow-2xl relative overflow-hidden">
      ...
      <div className="relative z-10 space-y-8">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 pb-6 border-b border-slate-800">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-cyan-950/80 border border-cyan-700/60 text-cyan-300 text-xs font-bold mb-3">
          ...
          <a
            ...
            className="flex items-center gap-2.5 px-4 py-2.5 bg-slate-800 hover:bg-slate-700 border border-slate-700 text-cyan-400 hover:text-cyan-300 rounded-2xl text-xs font-bold transition-all shrink-0 self-start lg:self-auto shadow-md"
          >
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
          <div className="bg-slate-800/60 border border-slate-700/80 rounded-2xl p-4 text-center">
            <div className="flex items-center justify-center gap-1 text-amber-400 font-black text-2xl sm:text-3xl">
              <span>5.0</span>
              <Star className="w-5 h-5 fill-amber-400" />
            </div>
            <div className="text-xs text-slate-400 mt-1 font-medium">คะแนนความพึงพอใจเฉลี่ย</div>
          </div>
          ...
          <div className="bg-slate-800/60 border border-slate-700/80 rounded-2xl p-4 text-center">
            ...
            <div className="text-xs text-slate-400 mt-1 font-medium">รีวิวจากลูกค้าและผู้เรียน</div>
          </div>
          ...
          <div className="bg-slate-800/60 border border-slate-700/80 rounded-2xl p-4 text-center">
            ...
            <div className="text-xs text-slate-400 mt-1 font-medium">อัตราส่งมอบงานสำเร็จ</div>
          </div>

          <div className="bg-slate-800/60 border border-slate-700/80 rounded-2xl p-4 text-center">
            <div className="text-cyan-400 font-black text-2xl sm:text-3xl">
              200+
            </div>
            <div className="text-xs text-slate-400 mt-1 font-medium">ผู้ผ่านการอบรมจริง</div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5">
          {filteredReviews.map((review) => (
            <div
              key={review.id}
              className="bg-slate-800/50 hover:bg-slate-800/80 border border-slate-700/70 hover:border-slate-600 rounded-2xl p-5 flex flex-col justify-between transition-all space-y-4 group"
            >
        ...
        {/* Footer Note */}
        <div className="bg-slate-800/40 p-4 rounded-2xl border border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-slate-400">
          ...
          >
            สอบถามรายละเอียดทาง LINE @zarntastic
          </a>
        </div>
